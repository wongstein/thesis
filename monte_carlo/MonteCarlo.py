...
#housekeeping functions for data management
        ...
        for key in sorted_keys:
            ...
            for t in range(0, season_length):
                ...
                for i in range(0, 365):
                    ...
                    b_hat_i_t = self.tables[key]['b_hat_i'][0, i] * self.this_trend.predict_forecasted_s_t((t_int + 1), 1)
    ...
    returns an int number of predicted reservations
    ...
    def predict(self, day):
        ...
        this_key = self.discover_season(day)

        predicted_reservations = self.predicted_reservations(day, this_key)
